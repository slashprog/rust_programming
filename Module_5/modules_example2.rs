...
mod mathlib {
    ...
    pub(in crate::mathlib::advanced) fn power(base: f64, exponent: f64) -> f64 { // Fails because visibility can be restricted only to ancestral modules.
        base.powf(exponent)
    }
...
fn main() {
    ...
    let power_result = mathlib::power(2.0, 3.0);
    ...
    let sqrt_result = mathlib::advanced::sqrt(16.0);
